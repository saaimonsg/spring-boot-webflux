...
public class HelloController {
    ...
    public Mono<String> delayed() {
        return Mono.just("Respuesta después de 3 segundos").delayElement(java.time.Duration.ofSeconds(3));
    }

    @GetMapping("/thread")
    public Mono<String> thread() {
        return Mono.fromSupplier(() -> "Hilo actual: " + Thread.currentThread().getName());
    }
